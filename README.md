# SC-300 Microsoft Entra Identity Study Guide

A Markdown-based repository for organizing SC-300 Microsoft Identity and Access Administrator study notes, assignments, cheatsheets, practice questions, screenshots, and printable exports.

## Official SC-300 Exam Skill Areas

| Official Skill Area | Exam Weight |
|---|---:|
...
Source: Microsoft Learn official SC-300 study guide.
...
| 8 | 8 | [assignments/section-08-assignment-08-block-high-risk-android-conditional-access.md](assignments/section-08-assignment-08-block-high-risk-android-conditional-access.md) | Draft |
...
Raw PDFs, exported course notes, private screenshots, tenant data, tenant IDs, object IDs, domains, real usernames, company/client information, subscription details, proprietary course links, and copied course instructions should stay local and should not be committed to this repository.
