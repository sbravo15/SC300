...
| Field | Details |
|---|---|
| Study focus | SC-300 foundation concepts for Microsoft cloud identity, AD DS, networking, lab setup, and course workflow |
| Source | sections/section-01-introduction.md |
| Output | Section-level study handout |
...
> **Note**
> This is a foundation section. It introduces the cloud, identity, networking, lab setup, and course workflow concepts needed for later SC-300 topics. Key terms link to the SC-300 glossary on first meaningful use.
...
- [ ] I can explain how Azure, Microsoft 365, and Microsoft Entra ID relate to each other.
- [ ] I can distinguish Microsoft Entra ID from on-premises Active Directory Domain Services.
- [ ] I can explain what domain controllers, DNS, Kerberos, NTLM, LDAP, and Group Policy do in AD DS.
- [ ] I can tell the difference between VPN, DMZ, firewall, and virtualization concepts.
- [ ] I can compare IaaS, PaaS, and SaaS using Microsoft cloud examples.
- [ ] I can explain why a dedicated lab tenant is safer than practicing in production.
- [ ] I can describe why course completion and passing the SC-300 certification exam are different outcomes.
